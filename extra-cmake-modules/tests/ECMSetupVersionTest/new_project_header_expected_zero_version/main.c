...
int main()
{
    intcheck(new_project_header_expected_zero_version_VERSION_MAJOR, 8) intcheck(new_project_header_expected_zero_version_VERSION_MINOR, 0)
        intcheck(new_project_header_expected_zero_version_VERSION_PATCH, 0)
            intcheck(new_project_header_expected_zero_version_VERSION, ((8 << 16) + (0 << 8) + 0))
                strcheck(new_project_header_expected_zero_version_VERSION_STRING, "08.00.0") return 0;
}

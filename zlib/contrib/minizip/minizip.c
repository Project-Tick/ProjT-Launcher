...
static void do_banner(void) {
    printf("MiniZip 1.1, demo of ptLib + MiniZip64 package, written by Gilles Vollant\n");
    printf("more info on MiniZip at http://www.winimage.com/ptlibzippyDll/minizip.html\n\n");
}

...
static DataChunk* decodeChunk(int* bits_length, unsigned char** bits, int version)
{
	...
	*bits += 4;
	...
	{
		case 0: return NULL;
		case 1: return decodeNum(bits_length, bits, version, 0);
		case 2: return decodeAn(bits_length, bits, version, 0);
		case 4: return decode8(bits_length, bits, version, 0);
		case 8: return decodeKanji(bits_length, bits, version, 0);
		default: break;
	}
...
static DataChunk* decodeChunkMQR(int* bits_length, unsigned char** bits, int version)
{
	...
	*bits += modebits;
	switch (val)
	{
		case 0: return decodeNum(bits_length, bits, version, 1);
		case 1: return decodeAn(bits_length, bits, version, 1);
		case 2: return decode8(bits_length, bits, version, 1);
		case 3: return decodeKanji(bits_length, bits, version, 1);
		default: break;
	}
...
int QRcode_decodeFormat(QRcode* code, QRecLevel* level, int* mask)
{
	...
	*mask = v1 & 7;
	switch ((v1 >> 3) & 3)
	{
		...
		case 0: *level = QR_ECLEVEL_M; break;
		case 3: *level = QR_ECLEVEL_Q; break;
		case 2: *level = QR_ECLEVEL_H; break;
		default: break;
	}
...
struct FormatInfo MQRformat[] = { { 1, QR_ECLEVEL_L }, { 2, QR_ECLEVEL_L }, { 2, QR_ECLEVEL_M }, { 3, QR_ECLEVEL_L },
								  { 3, QR_ECLEVEL_M }, { 4, QR_ECLEVEL_L }, { 4, QR_ECLEVEL_M }, { 4, QR_ECLEVEL_Q } };

...
str = ''''That's still pointless', she said.'''
    ...
    // value tests
    parse_expected_value(FILE_LINE_ARGS, R"("The quick brown fox jumps over the lazy dog")"sv,
    ...
    parse_expected_value(FILE_LINE_ARGS, R"(" Âñδ ωλèñ \"'ƨ ářè ïñ ƭλè ƨƭřïñϱ, áℓôñϱ ωïƭλ # \"")"sv,
                         R"( Âñδ ωλèñ "'ƨ ářè ïñ ƭλè ƨƭřïñϱ, áℓôñϱ ωïƭλ # ")"sv);
    parse_expected_value(FILE_LINE_ARGS, R"("Ýôú δôñ'ƭ ƭλïñƙ ƨô₥è úƨèř ωôñ'ƭ δô ƭλáƭ?")"sv,
...
// toml/pull/796 (\xHH unicode scalars)
    ...
    parse_expected_value(FILE_LINE_ARGS, R"("\x00\x10\x20\x30\x40\x50\x60\x70\x80\x90\x11\xFF\xEE")"sv,
                         "\u0000\u0010\u0020\u0030\u0040\u0050\u0060\u0070\u0080\u0090\u0011\u00FF\u00EE"sv);
#else

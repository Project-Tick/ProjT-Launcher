...
static constexpr auto newline_crlf =
    "os = \"DOS\"\r\n"
    "newline = \"crlf\""sv;
...
static constexpr auto spec_string_0 = R"(str = "I'm a string. \"You can quote me\". Name\tJos\u00E9\nLocation\tSF.")"sv;
...
TEST_CASE("conformance - burntsushi/valid")
{
    SECTION("array-array")
    {
        parsing_should_succeed(FILE_LINE_ARGS, array_array,
    ...
    SECTION("array-bool")
    {
        parsing_should_succeed(FILE_LINE_ARGS, array_bool,
    ...
    SECTION("array-empty")
    {
        parsing_should_succeed(FILE_LINE_ARGS, array_empty,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, array_hetergeneous,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, array_mixed_int_array,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, array_mixed_int_float,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, array_mixed_int_string,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, array_mixed_string_table,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, array_nested_double,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, array_nested_inline_table,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, array_nested,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, array_nospaces,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, array_string_quote_comma_2,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, array_string_quote_comma,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, array_string_with_comma_2,
...
Job: XXXX)"sv,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, array_string_with_comma,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, array_strings,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, array_table_array_string_backslash,
    ...
    SECTION("bool-bool")
    {
        parsing_should_succeed(FILE_LINE_ARGS, bool_bool,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, comment_after_literal_no_ws,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, comment_at_eof,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, comment_at_eof2,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, comment_everywhere,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, comment_noeol,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, comment_tricky,
...
#also not comment)"sv },
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, comment_nonascii,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, datetime_datetime,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, datetime_local_date,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, datetime_local_time,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, datetime_local,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, datetime_milliseconds,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, datetime_timezone,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, datetime_no_seconds,
    ...
    SECTION("empty-file")
    {
        parsing_should_succeed(FILE_LINE_ARGS, empty_file,
    ...
    SECTION("example")
    {
        parsing_should_succeed(FILE_LINE_ARGS, example,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, float_exponent,
    ...
    SECTION("float-float")
    {
        parsing_should_succeed(FILE_LINE_ARGS, float_float,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, float_inf_and_nan,
    ...
    SECTION("float-long")
    {
        parsing_should_succeed(FILE_LINE_ARGS, float_long,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, float_underscore,
    ...
    SECTION("float-zero")
    {
        parsing_should_succeed(
            FILE_LINE_ARGS, float_zero,
            [](toml::table&& tbl)  // float-zero
            {
                const auto expected = toml::table{
                    { R"(exponent)"sv, 0.0 },       { R"(exponent-signed-neg)"sv, -0.0 }, { R"(exponent-signed-pos)"sv, 0.0 },
                    { R"(exponent-two-0)"sv, 0.0 }, { R"(signed-neg)"sv, -0.0 },          { R"(signed-pos)"sv, 0.0 },
                    { R"(zero)"sv, 0.0 },
                };
                REQUIRE(tbl == expected);
            });
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, implicit_and_explicit_after,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, implicit_and_explicit_before,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, implicit_groups,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, inline_table_array,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, inline_table_bool,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, inline_table_empty,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, inline_table_end_in_bool,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, inline_table_inline_table,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, inline_table_multiline,
...
another line)"sv },
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, inline_table_nest,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, inline_table_key_dotted,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, inline_table_newline,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, integer_integer,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, integer_literals,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, integer_long,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, integer_underscore,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, integer_zero,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, key_case_sensitive,
    ...
    SECTION("key-escapes")
    {
        parsing_should_succeed(FILE_LINE_ARGS, key_escapes,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, key_quoted_unicode,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, key_dotted_empty,
    ...
    SECTION("key-dotted")
    {
        parsing_should_succeed(FILE_LINE_ARGS, key_dotted,
    ...
    SECTION("key-empty")
    {
        parsing_should_succeed(FILE_LINE_ARGS, key_empty,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, key_equals_nospace,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, key_numeric_dotted,
    ...
    SECTION("key-numeric")
    {
        parsing_should_succeed(FILE_LINE_ARGS, key_numeric,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, key_quoted_dots,
    ...
    SECTION("key-space")
    {
        parsing_should_succeed(FILE_LINE_ARGS, key_space,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, key_special_chars,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, key_special_word,
    ...
    SECTION("key-unicode")
    {
        parsing_should_succeed(FILE_LINE_ARGS, key_unicode,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, newline_crlf,
    ...
    SECTION("newline-lf")
    {
        parsing_should_succeed(FILE_LINE_ARGS, newline_lf,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_array_0,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_array_1,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_array_of_tables_0,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_array_of_tables_1,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_array_of_tables_2,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_boolean_0,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_comment_0,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_float_0,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_float_1,
    ...
    {
        parsing_should_succeed(
            FILE_LINE_ARGS, spec_float_2,
            [](toml::table&& tbl)  // spec-float-2
            {
                const auto expected = toml::table{
                    { R"(sf1)"sv, std::numeric_limits<double>::infinity() },  { R"(sf2)"sv, std::numeric_limits<double>::infinity() },
                    { R"(sf3)"sv, -std::numeric_limits<double>::infinity() }, { R"(sf4)"sv, std::numeric_limits<double>::quiet_NaN() },
                    { R"(sf5)"sv, std::numeric_limits<double>::quiet_NaN() }, { R"(sf6)"sv, std::numeric_limits<double>::quiet_NaN() },
                };
                REQUIRE(tbl == expected);
            });
    }
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_inline_table_0,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_inline_table_1,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_inline_table_2,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_inline_table_3,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_integer_0,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_integer_1,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_integer_2,
                               [](toml::table&& tbl)  // spec-integer-2
                               {
                                   const auto expected = toml::table{
                                       { R"(bin1)"sv, 214 },        { R"(hex1)"sv, 3735928559 }, { R"(hex2)"sv, 3735928559 },
                                       { R"(hex3)"sv, 3735928559 }, { R"(oct1)"sv, 342391 },     { R"(oct2)"sv, 493 },
                                   };
                                   REQUIRE(tbl == expected);
                               });
    }
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_key_value_pair_0,
    ...
    SECTION("spec-keys-0")
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_keys_0,
    ...
    SECTION("spec-keys-3")
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_keys_3,
    ...
    SECTION("spec-keys-4")
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_keys_4,
    ...
    SECTION("spec-keys-5")
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_keys_5,
    ...
    SECTION("spec-keys-6")
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_keys_6,
    ...
    SECTION("spec-keys-7")
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_keys_7,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_local_date_0,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_local_date_time_0,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_local_time_0,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_offset_date_time_0,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_offset_date_time_1,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_string_1,
...
Violets are blue)"sv },
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_string_2,
...
Violets are blue)"sv },
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_string_3,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_string_4,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_string_5,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_string_6,
...
trimmed in raw strings.
   ...
   is preserved.
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_string_7,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_table_0,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_table_1,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_table_2,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_table_4,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_table_5,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_table_6,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_table_7,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_table_8,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_table_9,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_example_1_compact,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_example_1,
    ...
    SECTION("spec-keys-1")
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_keys_1,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_string_0,
...
Location	SF.)"sv },
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, spec_table_3,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, string_double_quote_escape,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, string_empty,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, string_escaped_escape,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, string_escapes,
 ...
 new line character.)"sv },
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, string_multiline_escaped_crlf,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, string_multiline_quotes,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, string_multiline,
...
b)"sv },
  ...
  b)"sv },
    ...
    SECTION("string-nl")
    {
        parsing_should_succeed(FILE_LINE_ARGS, string_nl,
...
ue)"sv },
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, string_raw_multiline,
...
in it.)"sv },
    ...
    SECTION("string-raw")
    {
        parsing_should_succeed(FILE_LINE_ARGS, string_raw,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, string_simple,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, string_with_pound,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, string_escape_esc,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, string_escape_tricky,
    ...
    {
        parsing_should_succeed(
            FILE_LINE_ARGS, string_quoted_unicode,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, string_unicode_escape,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, string_unicode_literal,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, string_hex_escape,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, table_array_implicit_and_explicit_after,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, table_array_implicit,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, table_array_many,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, table_array_nest,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, table_array_one,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, table_array_table_array,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, table_array_within_dotted,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, table_empty_name,
    ...
    SECTION("table-empty")
    {
        parsing_should_succeed(FILE_LINE_ARGS, table_empty,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, table_keyword,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, table_no_eol,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, table_sub_empty,
    ...
    SECTION("table-sub")
    {
        parsing_should_succeed(FILE_LINE_ARGS, table_sub,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, table_whitespace,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, table_with_literal_string,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, table_with_pound,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, table_with_single_quotes,
    ...
    {
        parsing_should_succeed(FILE_LINE_ARGS, table_without_super,
    ...
    SECTION("table-names")
    {
        parsing_should_succeed(FILE_LINE_ARGS, table_names,

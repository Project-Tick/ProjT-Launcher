...
# See https://github.com/Project-Tick/ProjT-Launcher/blob/main/tomlplusplus/LICENSE for the full license text.
...
def write_test_file(name, all_tests):
	...
	with StringIO() as test_file_buffer:
		...
		write(r'// Copyright (c) 2026 Project Tick')
		write(r'// See https://github.com/Project-Tick/ProjT-Launcher/blob/main/tomlplusplus/LICENSE for the full license text.')

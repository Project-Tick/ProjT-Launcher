 ...
 * 
 * ======================================================================== */
package tr.org.projecttick.projtlauncher.normal;
...
public final class SystemProperties {
    public static void apply(Parameters params) {
        ...
        if (name != null)
            System.setProperty("tr.org.projecttick.projtlauncher.normal.instance.name", name);
        if (iconId != null)
            System.setProperty("tr.org.projecttick.projtlauncher.normal.instance.icon.id", iconId);
        if (iconPath != null)
            System.setProperty("tr.org.projecttick.projtlauncher.normal.instance.icon.path", iconPath);
        if (windowTitle != null)
            System.setProperty("tr.org.projecttick.projtlauncher.normal.window.title", windowTitle);
        if (windowDimensions != null)
            System.setProperty("tr.org.projecttick.projtlauncher.normal.window.dimensions", windowDimensions);

...
void BackupDialog::on_createButton_clicked()
{
    ...
    if (m_backupManager->createBackup(m_instance, backupName, options)) {
        QMessageBox::information(this, tr("Success"), tr("Backup created successfully!"));
    } else {
        QMessageBox::critical(this, tr("Error"), tr("Failed to create backup."));
    }
}
...
void BackupDialog::on_restoreButton_clicked()
{
    ...
    if (m_backupManager->restoreBackup(m_instance, backup, createSafetyBackup)) {
        QMessageBox::information(this, tr("Success"), tr("Backup restored successfully!"));
    } else {
        QMessageBox::critical(this, tr("Error"), tr("Failed to restore backup."));
    }
}

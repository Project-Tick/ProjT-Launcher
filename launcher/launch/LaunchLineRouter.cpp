...
bool LaunchLineRouter::parseStructured(const QString& line, MessageLevel::Enum level, LaunchLogModel& model,
...
void LaunchLineRouter::routeLine(QString line, MessageLevel::Enum defaultLevel, LaunchLogModel& model,
								 const QMap<QString, QString>& redactions)
{

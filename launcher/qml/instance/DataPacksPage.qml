        ...
        RowLayout {
            ...
            ComboBox {
                ...
                onCurrentIndexChanged: {
                    if (vm) vm.selectWorldForDataPacks(currentIndex)
                }
            }
                ...
                delegate: ItemDelegate {
                    ...
                    RowLayout {
                        ...
                        CheckBox {
                            ...
                            onCheckedChanged: {
                                if (vm) vm.setDataPackEnabled(index, checked)
                            }
                        }

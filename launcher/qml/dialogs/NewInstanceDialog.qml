    ...
    RowLayout {
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                Repeater {
                    model: [
                        { id: "vanilla", name: qsTr("Vanilla"), icon: "🎮" },
                        { id: "curseforge", name: "CurseForge", icon: "🔥" },
                        { id: "modrinth", name: "Modrinth", icon: "🌿" },
                        { id: "atlauncher", name: "ATLauncher", icon: "⚡" },
                        { id: "ftb", name: "FTB", icon: "📦" },
                        { id: "technic", name: "Technic", icon: "⚙" },
                        { id: "import", name: qsTr("Import"), icon: "📂" }
                    ]
    ...
    component VanillaPage: ColumnLayout {
        ...
        RowLayout {
            ...
            Button {
                ...
                onClicked: {
                    if (vm) {
                        vm.createNewInstance(
                            vanillaNameField.text,
                            vanillaGroupCombo.editText,

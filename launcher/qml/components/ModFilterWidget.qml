        ...
        ColumnLayout {
            ...
            GroupBox {
                ...
                ColumnLayout {
                    ...
                    Repeater {
                        model: ["Adventure", "Decoration", "Equipment", "Food", "Library", "Magic", "Optimization", "Social", "Storage", "Technology", "Transportation", "Utility", "World Generation"]
